...
if "tickers_text" not in st.session_state:
    st.session_state["tickers_text"] = "HRT.WA,CFS.WA,PRT.WA,ATT.WA,STX.WA,PUR.WA,BCS.WA,KCH.WA,GTN.WA,LBW.WA,PGV.WA,HPE.WA,DNS.WA,ZUK.WA,VVD.WA,HIVE,MLM.WA,MER.WA,APS.WA,NVG.WA,IOVA,PLRX,HUMA,TCRX,GOSS,MREO,ADTX,EVGV"
...
3. 3 ostrzeżenia (przegrzanie / słabość) — krótko i konkretnie.
4. Werdykt końcowy — jedno zdanie, bez porad.
"""
                resp = client.chat.completions.create(
                    model="gpt-4o-mini",
