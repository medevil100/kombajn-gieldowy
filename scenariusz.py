...
Jeżeli wrzucasz to na Streamlit Cloud, użyj takiego `requirements.txt`:
...
Nie dodawaj już `cloudscraper`, bo w tym skrypcie nie jest potrzebny.

---

## Streamlit Secrets

W Streamlit Cloud ustaw:
...
A lokalnie możesz użyć zmiennych środowiskowych albo pliku:
